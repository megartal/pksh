...
class __TwigTemplate_193d720391707392ab00b9d3eddbee7a68560eaf6dace71f0f8244ed9d5dc457 extends Twig_Template
{
    ...
    <div class=\"row\">
      ";
        ...
        if ((isset($context["informations"]) ? $context["informations"] : null)) {
            // line 5
            echo "      <div class=\"col-sm-3 visibility: hidden\">
        <h5>";
            // line 6
...
/*           <li class="visibility: hidden"><a href="{{ return }}">{{ text_return }}</a></li>*/
...
/*           <li class="visibility: hidden"><a href="{{ voucher }}">{{ text_voucher }}</a></li>*/
/*           <li class="visibility: hidden"><a href="{{ affiliate }}">{{ text_affiliate }}</a></li>*/
