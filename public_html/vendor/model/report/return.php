...
class ModelReportReturn extends Model {
	public function getReturns($data = array()) {
		...
		//Start add
		$sql .= " AND EXISTS (SELECT op.order_id FROM " . DB_PREFIX . "order_product op WHERE op.vendor_id = '". (int)$this->user->getId() ."' AND op.order_id=r.order_id AND op.model=r.model)";
        //End add
