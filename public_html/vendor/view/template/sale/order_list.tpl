          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group visibility: hidden">
                ...
                <select name="filter_order_status" id="input-order-status" class="form-control visibility: hidden">
                  <option value="*"></option>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <!-- <td class="text-left visibility: hidden"><?php echo $order['status']; ?></td> -->
                  <!-- //changed!
