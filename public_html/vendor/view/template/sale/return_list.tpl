            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'r.product') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left visibility: hidden"><?php if ($sort == 'r.model') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left visibility: hidden"><?php echo $return['model']; ?></td>
                  <td class="text-left visibility: hidden"><?php echo $return['status']; ?></td>
