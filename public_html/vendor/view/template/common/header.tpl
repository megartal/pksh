  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://pakhshplus.ir" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li class="visibility: hidden"><a href="http://extensionsell.com/Vendor-documentation" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li class="visibility: hidden"><a href="http://forum.extensionsell.com" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
