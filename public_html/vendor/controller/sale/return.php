...
class ControllerSaleReturn extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $return_id) {
				//Start add
				$return_query = $this->model_sale_return->getUserReturns($return_id);
				if(!$return_query){
	...
	protected function validateForm() {
	    ...
	    if(isset($this->request->get['return_id'])){
		    $this->load->model('sale/return');
		    $return_query = $this->model_sale_return->getUserReturns($this->request->get['return_id']);
		    if(!$return_query){
			   $this->error['warning'] = 'You cant modify this return';		  
		    }		
		}
		//End add
