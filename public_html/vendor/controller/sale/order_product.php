...
class ControllerSaleOrderProduct extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['invoice'] = $this->url->link('sale/order_product/invoice', 'token=' . $this->session->data['token'], 'SSL');
		$data['history'] = $this->url->link('sale/order_product/history', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['products'] = array();
		...
		$data['sort_order'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.order_id' . $url, 'SSL');
		$data['sort_name'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.name' . $url, 'SSL');
		$data['sort_model'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.model' . $url, 'SSL');
		$data['sort_quantity'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.quantity' . $url, 'SSL');
		$data['sort_unit_price'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.price' . $url, 'SSL');
		$data['sort_unit_tax'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.tax' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=op.total' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('sale/order_product.tpl', $data));
	}
	public function history() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
		    ...
		    $this->response->redirect($this->url->link('sale/order_product', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    }
	public function invoice() {
		...
		$this->response->setOutput($this->load->view('sale/order_product_invoice.tpl', $data));
	}
