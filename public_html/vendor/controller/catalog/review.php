...
class ControllerCatalogReview extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $review_id) {
				//Start add
				$review_query = $this->model_catalog_review->getUserReviews($review_id);
				if(!$review_query){
	...
	protected function validateForm() {
		...
		if(isset($this->request->post['product_id'])){
			...
			$product_query = $this->model_catalog_product->getUserItem($this->request->post['product_id'],'product');
			if(!$product_query){
				$this->error['warning'] = 'You cant add this product';
			}
	    }
		if (isset($this->request->get['review_id'])){
		    $this->load->model('catalog/review');
		    $review_query = $this->model_catalog_review->getUserReviews($this->request->get['review_id']);
		    if(!$review_query){
			   $this->error['warning'] = 'You cant modify this review';		  
		    }		
		}
		//End add
