...
class ControllerCatalogProduct extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
				//Start add
				$product_query = $this->model_catalog_product->getUserItem($product_id,'product');
				if(!$product_query){
					die('You cant modify this product');		  
				}
				//End add
	...
	protected function validateForm() {
		...
		if (isset($this->request->get['product_id'])){
		    $this->load->model('catalog/product');
		    $product_query = $this->model_catalog_product->getUserItem($this->request->get['product_id'],'product');
		    if(!$product_query){
				$this->error['warning'] = 'You cant modify this product';		  
		    }
		}
		//End add
