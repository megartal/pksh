...
class ControllerAccountReturn extends Controller {
	...
	public function add() {
		...
		$this->document->setTitle($this->language->get('heading_title'));
		$this->document->addScript('catalog/view/javascript/jquery/datetimepicker/js/bootstrap-datepicker.fa.min.js');
		$this->document->addScript('catalog/view/javascript/jquery/datetimepicker/js/bootstrap-datepicker.min.js');
		$this->document->addStyle('catalog/view/javascript/jquery/datetimepicker/css/bootstrap-datepicker.min.css');
